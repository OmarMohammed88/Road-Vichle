...
<div id="main">
	...
	<div class="headerbar">
        ...
        <div class="headerbar-left">
            <a href="index.php" class="logo"><img alt="Logo" src="adminhome/assets/images/logo.png" /> <span>Admin</span></a>
        </div>
	...
	<div class="left main-sidebar">
		...
		<div class="sidebar-inner leftscroll">
			...
			<ul>
					...
					<li class="submenu">
                                            <a href="adminhome.php"><i class="fa fa-fw fa-bars"></i><span> Dashboard </span> </a>
                    </li>

					<li class="submenu">
                        <a href="#" class="active"><i class="fa fa-fw fa-table"></i> <span> Tables </span> <span class="menu-arrow"></span></a>
							<ul class="list-unstyled">
                                                            <li><a href="adminhome/View_User.php">View User</a></li>
                                                            <li class="active"><a href="View_Mechanic.php">View Mechanic</a></li>
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
							<div class="card mb-3">
								<div class="card-header">
									<h3><i class="fa fa-table"></i>Display All Feedback</h3>
								...
								<div class="card-body">
									...
									<table id="example1" class="table table-bordered table-hover display">
										...
										<?php
                                                                                        ...
                                                                                        $r= mysqli_query($conn,"SELECT users.username, feedback.feedback FROM users INNER JOIN feedback ON users.id = feedback.`id-actor`");
                                                                                        $count=1;
