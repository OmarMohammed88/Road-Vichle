...
<head>
		...
		<!-- Favicon -->
                <link rel="shortcut icon" href="mechanichome/assets/images/favicon.ico">
...
<div id="main">
	...
	<div class="left main-sidebar">
		...
		<div class="sidebar-inner leftscroll">
			...
			<ul>
					...
					<li class="submenu">
                                            <a class="active" href="userhome.php"><i class="fa fa-fw fa-bars"></i><span> Dashboard </span> </a>
                    </li>



					<li class="submenu">
                        <a href="#"><i class="fa fa-fw fa-table"></i> <span> User Premmesion </span> <span class="menu-arrow"></span></a>
	...
	<footer class="footer">
		...
		Copyright <a target="_blank" href="#">Modest</a>
		</span>
...
<!-- BEGIN Java Script for this page -->
	...
	<!-- Counter-Up-->
        <script src="mechanichome/assets/plugins/waypoints/lib/jquery.waypoints.min.js"></script>
        <script src="mechanichome/assets/plugins/counterup/jquery.counterup.min.js"></script>
