...
$admin->allow_mechanics($username);

}
if(isset($_POST['block'])){
$admin->block_mechanic($username);
							...
							<div class="card mb-3">
								...
								<div class="card-body">
                                    ...
                                    <div class="card-body">
                                                    ...
                                                    <button type="submit"  class="btn btn-outline-success" value="allow" name="allow" >Allow </button>
                                                    <button type="submit"  class="btn btn-outline-success" value="block" name="block" >Block </button>
                                                            </form>
